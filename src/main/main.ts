...
async function requestQuit(): Promise<void> { if (shutdownPending || shutdownComplete) return; shutdownPending = true; await runtime?.stop(); shutdownComplete = true; shutdownPending = false; app.quit(); }
